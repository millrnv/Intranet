...
public class EstudianteDAO {
    public static void agregarEstudiante(DSLContext query, Estudiante estudiante){
        ...
        query.insertInto(tablaEstudiante, columnas[0], columnas[1],columnas[2],columnas[3]).values(estudiante.getRut(),estudiante.getNombre(),estudiante.getnMatricula(),estudiante.getCarrera().getCodCarrera()).execute();
    }
    ...
    private List obtenerListaEstudiantes(Result resultados){
        ...
        for(int fila=0; fila<resultados.size();fila++){
            ...
            estudiantes.add(new Estudiante(nombre,rut,apellido,matricula,null));
        }
        return estudiantes;
    }
